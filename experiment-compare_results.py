...
def retrieve(user_query, num, embedding_model):
    ...
    for i in range(first_num):
        ...
        pure_result = final_results[i][0].replace("\n", " ")
        return_messages.append(user_query + " " + pure_result)
    
    avrg_score = total_score / first_num
    
    return return_messages, avrg_score
...
if __name__ == "__main__":
    ...
    '''
    results_similarity, score = retrieve(user_query, num, embedding_model)
    
    histories = ""
    
    for result_similarity in results_similarity:

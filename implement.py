...
def retrieve_with_re_ranker(user_query, num, use_finetuned, embedding_model, reranker_model, reranker_tokenizer):
    """
...
if __name__ == "__main__":
    ...
    for i in range(len(user_queries)):
        ...
        if config.reranker is not None:
            ...
            result = retrieve_with_re_ranker(query, num, use_finetuned, embedding_model, reranker_model, reranker_tokenizer)
        else:
            # Naive retrieve
